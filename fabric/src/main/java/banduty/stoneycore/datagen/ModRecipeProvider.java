...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, SCItems.TONGS.get(), 1)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(StoneyCore.MOD_ID, getSimpleRecipeName(SCItems.TONGS.get())));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, SCItems.SMITHING_HAMMER.get(), 1)
                ...
                .unlockedBy(getHasName(Items.IRON_INGOT), has(Items.IRON_INGOT))
                .unlockedBy(getHasName(Items.IRON_NUGGET), has(Items.IRON_NUGGET))
                .save(exporter, ResourceLocation.fromNamespaceAndPath(StoneyCore.MOD_ID, getSimpleRecipeName(SCItems.SMITHING_HAMMER.get())));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, SCItems.BLACK_POWDER.get(), 4)
                ...
                .save(exporter, ResourceLocation.fromNamespaceAndPath(StoneyCore.MOD_ID, getSimpleRecipeName(SCItems.BLACK_POWDER.get())));
