...
public class BlueprintScreenHandler extends AbstractContainerMenu {
    ...
    public BlueprintScreenHandler(int syncId, Inventory inventory, RegistryFriendlyByteBuf buf) {
        this(syncId, inventory, ItemStack.STREAM_CODEC.decode(buf), buf.readResourceLocation());
    }
