...
public class MuzzlesSmokeParticle extends SpriteBillboardParticle {
    ...
    public MuzzlesSmokeParticle(ClientWorld world, double xCoord, double yCoord, double zCoord,
        ...
        this.velocityMultiplier = Math.max(0.99f + (StoneyCore.getConfig().visualOptions.getMuzzlesSmokeParticlesTime() / 20000f), 0.997f);
        this.velocityX = xd;
        this.velocityY = yd;
        this.velocityZ = zd;
        ...
        this.scale *= 1.8f;
        this.maxAge = StoneyCore.getConfig().visualOptions.getMuzzlesSmokeParticlesTime() * 20;
