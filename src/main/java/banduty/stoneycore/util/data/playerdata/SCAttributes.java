...
public class SCAttributes {
    ...
    public static final Attribute STAMINA = make("stamina", 0.0, -1024.0, 1024.0);
    public static final Attribute MAX_STAMINA = make("max_stamina", StoneyCore.getConfig().combatOptions.maxBaseStamina(), -1024.0, 1024.0);
