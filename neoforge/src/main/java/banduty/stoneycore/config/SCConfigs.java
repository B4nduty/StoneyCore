...
public class SCConfigs {
    ...
    public static final ModConfigSpec.DoubleValue onBlockStaminaConstant;
    public static final ModConfigSpec.DoubleValue onParryStaminaConstant;
    public static final ModConfigSpec.DoubleValue sprintingStaminaConstant;
    public static final ModConfigSpec.DoubleValue jumpingStaminaConstant;
    public static final ModConfigSpec.DoubleValue swimmingStaminaConstant;
    public static final ModConfigSpec.DoubleValue attackStaminaConstant;
    ...
    public static final ModConfigSpec.BooleanValue breakOrRemoveSiegeDestroy;

    // Land settings
    public static final ModConfigSpec.BooleanValue claimLand;
    public static final ModConfigSpec.BooleanValue removeClaimedSiege;
    public static final ModConfigSpec.BooleanValue hungerSiege;
    public static final ModConfigSpec.BooleanValue landVisitors;
